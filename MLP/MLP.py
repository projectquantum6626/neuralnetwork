...
data_file, output_col, hidden_layer = '../input/processed/S&P.csv', 'Movement', (8,6)
...
classifier=MLPClassifier(hidden_layer_sizes=hidden_layer, max_iter=500, alpha=0.0001,
                            solver='sgd', verbose=10,  random_state=21,tol=0.000001)
